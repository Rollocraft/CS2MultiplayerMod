...
namespace CS2MultiplayerMod.Game.Sync.Channels
{
    ...
    public sealed class ZoneDemandChannel : IStateChannel
    {
        ...
        public bool Capture(EntityManager em, NetworkWriter writer)
        {
            ...
            writer.WriteInt(_growables.CalculateEntityCount());
            writer.WriteInt(_residentialProperties.CalculateEntityCount());
            writer.WriteInt(_commercialProperties.CalculateEntityCount());
            writer.WriteInt(_industrialProperties.CalculateEntityCount());
            writer.WriteInt(_households.CalculateEntityCount());
            writer.WriteInt(_citizens.CalculateEntityCount());
            writer.WriteInt(_pets.CalculateEntityCount());
            return true;
        }
