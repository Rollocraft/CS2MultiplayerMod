...
{
    // Encoding one captured definition, with endpoints and owners described by prefab and position.
    public partial class NetSyncSystem
    {
        /// <summary>
        /// An original-backed member of a mixed graph as a delete/replace item, published only inside a
        /// <see cref="NetToolOperationCommand"/>. A reason voids the envelope; null with no reason is a hidden
        /// sub-net the receiver recreates.
        /// </summary>
            ...
            CreationDefinition definition, NetCourse course, out string unrepresentable)
        {
            ...
            // Before the owner rule: a building connector is both owned and hidden, and hidden wins.
        ...
        /// <summary>
        /// The wire command for one course. Null with no reason is a hidden sub-net skip; a reason voids
        /// the envelope.
        /// </summary>
            ...
            NetCourse course, out string unrepresentable)
        {
            ...
            // An unnamed prefab cannot be addressed; dropping it would cut the operation.
